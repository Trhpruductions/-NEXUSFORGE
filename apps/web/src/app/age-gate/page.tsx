    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(251,191,36,0.18),_transparent_28%),linear-gradient(180deg,_#020617_0%,_#08101f_38%,_#020617_100%)] text-white">
      <main id="main-content" className="mx-auto flex min-h-screen max-w-7xl flex-col justify-center px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] xl:gap-12">
          <section className="rounded-none border border-amber-500/10 bg-slate-950/85 p-10 shadow-[0_36px_140px_rgba(0,0,0,0.36)] backdrop-blur-xl lg:p-12">
            <div className="max-w-3xl space-y-6">
              <span className="inline-flex items-center rounded-none border border-amber-400/20 bg-amber-500/10 px-4 py-2 text-xs uppercase tracking-[0.32em] text-amber-200">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-none border border-slate-700/70 bg-slate-900/90 p-6">
              ...
              <div className="rounded-none border border-amber-500/30 bg-amber-500/5 p-6 text-slate-200">
          ...
          <section className="rounded-none border border-slate-700/70 bg-slate-900/95 p-8 shadow-[0_24px_90px_rgba(15,23,42,0.32)] lg:p-10">
            <div className="mb-8 rounded-none border border-amber-500/15 bg-slate-950/90 p-6">
            ...
            <Suspense fallback={<div className="rounded-none border border-slate-700/70 bg-slate-950/90 p-6 text-sm text-slate-300">Loading secure verification...</div>}>
              <AgeGateClient />
            </Suspense>

            <div className="mt-8 rounded-none border border-slate-700/70 bg-slate-950/90 p-6 text-sm text-slate-300">
