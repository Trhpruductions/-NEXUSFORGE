  ...
  return (
    ...
    >
      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="nexus-panel-glass rounded-[28px] border border-slate-900/10 bg-white/85 p-6 shadow-[0_24px_60px_rgba(15,23,42,0.08)] backdrop-blur-xl">
          <p className="text-[10px] uppercase tracking-[0.28em] text-amber-600">Beta overview</p>
          <h2 className="mt-4 text-2xl font-semibold text-slate-950">Launch the desktop-first workspace with a single step.</h2>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            {[
              ...
              <div key={item.label} className="rounded-[22px] border border-slate-900/10 bg-slate-50 p-4">
        ...
        <div className="nexus-panel-glass rounded-[28px] border border-slate-900/10 bg-white/85 p-6 shadow-[0_24px_60px_rgba(15,23,42,0.08)] backdrop-blur-xl">
          <p className="text-[10px] uppercase tracking-[0.28em] text-amber-600">Quick status</p>
      ...
      <section className="nexus-display-panel rounded-[28px] border border-slate-900/10 bg-white/85 p-5 shadow-[0_24px_60px_rgba(15,23,42,0.08)] sm:p-6">
        <p className="text-[11px] uppercase tracking-[0.2em] text-amber-600">Tester Onboarding</p>
        <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <Link
            href="/register?redirect=%2Fapp"
            className="nexus-interactive-btn inline-flex h-11 items-center justify-center rounded-full border border-slate-900/10 bg-white px-4 text-sm font-semibold text-slate-900 hover:bg-slate-50"
          >
            Create Beta Account
          </Link>
          <Link
          ...
          <Link
            href="/search"
            className="nexus-interactive-btn inline-flex h-11 items-center justify-center rounded-full border border-slate-900/10 bg-slate-50 px-4 text-sm font-semibold text-slate-900 hover:bg-white"
          >
            Explore Community
          </Link>
          <Link
        ...
        <div className="nexus-display-panel mt-5 rounded-[24px] border border-slate-900/10 bg-slate-50 p-4 text-sm text-slate-600">
          <p className="text-[10px] uppercase tracking-[0.18em] text-slate-500">Recommended Beta Flow</p>
          <ol className="mt-2 list-decimal space-y-1 pl-5">
            <li>Create an account.</li>
            <li>Sign in and open the workspace.</li>
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2">
          <Link
            href="/beta/checklist"
            className="nexus-interactive-btn rounded-full border border-slate-900/10 bg-white px-4 py-3 text-sm text-slate-900 hover:bg-slate-50"
          >
            Open Test Checklist
          </Link>
          <Link
