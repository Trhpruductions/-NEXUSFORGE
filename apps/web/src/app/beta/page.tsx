  ...
  return (
    ...
    >
      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="nexus-panel-glass rounded-none border border-amber-400/10 bg-slate-950/80 p-6 shadow-[0_30px_90px_rgba(0,0,0,0.22)]">
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            {[
              ...
              <div key={item.label} className="rounded-none border border-slate-700/70 bg-slate-900/90 p-4">
        ...
        <div className="nexus-panel-glass rounded-none border border-slate-700/60 bg-slate-950/80 p-6 shadow-[0_30px_90px_rgba(0,0,0,0.18)]">
          ...
          <div className="mt-5 grid gap-3">
            {[
              ...
              <div key={item.label} className="rounded-none bg-slate-900/90 p-4">
                <p className="text-[10px] uppercase tracking-[0.22em] text-slate-500">{item.label}</p>
                <p className="mt-2 text-sm font-semibold text-white">{item.value}</p>
              </div>
            ))}
      ...
      <section className="nexus-display-panel rounded-none p-5 sm:p-6">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <Link
            ...
            className="nexus-interactive-btn inline-flex h-11 items-center justify-center rounded-none border border-amber-500/45 bg-amber-950/25 px-4 text-sm font-semibold text-amber-100 hover:border-amber-300"
          >
            Create Beta Account
          </Link>
          <Link
          ...
          <Link
            href="/search"
            className="nexus-interactive-btn inline-flex h-11 items-center justify-center rounded-none border border-slate-700/80 bg-slate-900/80 px-4 text-sm font-semibold text-slate-100 hover:border-amber-500/45"
          >
            Explore Community
          </Link>
          <Link
        ...
        <div className="nexus-display-panel mt-5 rounded-none p-4 text-sm text-slate-300">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2">
          <Link
            href="/beta/checklist"
            className="nexus-interactive-btn rounded-none border border-amber-500/30 bg-amber-950/20 px-4 py-3 text-sm text-amber-100 hover:border-amber-300"
          >
            Open Test Checklist
          </Link>
          <Link
