  ...
  return (
    ...
    >
      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="nexus-panel-glass rounded-[28px] border border-white/10 bg-[#11151e] p-6 shadow-[0_24px_60px_rgba(15,23,42,0.08)] backdrop-blur-xl">
          <p className="text-[10px] uppercase tracking-[0.28em] text-amber-300">Beta overview</p>
          <h2 className="mt-4 text-2xl font-semibold text-white">Launch the desktop-first workspace with a single step.</h2>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            {[
              ...
              <div key={item.label} className="rounded-[22px] border border-white/10 bg-[#0d1119] p-4">
      ...
      <section className="nexus-display-panel rounded-[28px] border border-white/10 bg-[#11151e] p-5 shadow-[0_24px_60px_rgba(15,23,42,0.08)] sm:p-6">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <Link
            ...
            className="nexus-interactive-btn inline-flex h-11 items-center justify-center rounded-full border border-white/10 bg-amber-400 px-4 text-sm font-semibold text-slate-950 hover:bg-[#0d1119]"
          >
            Create Beta Account
          </Link>
          <Link
          ...
          <Link
            href="/search"
            className="nexus-interactive-btn inline-flex h-11 items-center justify-center rounded-full border border-white/10 bg-[#0d1119] px-4 text-sm font-semibold text-slate-950 hover:bg-amber-400"
          >
            Explore Community
          </Link>
          <Link
        ...
        <div className="nexus-display-panel mt-5 rounded-[24px] border border-white/10 bg-[#0d1119] p-4 text-sm text-slate-400">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2">
          <Link
            href="/beta/checklist"
            className="nexus-interactive-btn rounded-full border border-white/10 bg-amber-400 px-4 py-3 text-sm text-slate-950 hover:bg-[#0d1119]"
          >
            Open Test Checklist
          </Link>
          <Link
