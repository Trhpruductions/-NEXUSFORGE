    ...
    >
      <section className="nexus-display-panel rounded-[28px] p-5 sm:p-6">
        ...
        <div className="mt-5 flex flex-wrap gap-2">
          <Link
            href="/app"
            className="nexus-interactive-btn inline-flex h-10 items-center rounded-xl border border-amber-500/35 bg-amber-950/25 px-4 text-sm font-semibold text-amber-100 hover:border-amber-300"
          >
