  ...
  return (
    ...
    >
      <div className="grid gap-6 lg:grid-cols-[1.08fr_0.92fr]">
        <div className="nexus-panel-glass rounded-[32px] border border-slate-700/70 bg-slate-950/85 p-6 shadow-[0_30px_80px_rgba(0,0,0,0.35)]">
        ...
        <aside className="nexus-panel-glass rounded-[32px] border border-slate-700/70 bg-slate-950/85 p-6 shadow-[0_30px_80px_rgba(0,0,0,0.35)]">
          ...
          <div className="mt-6 grid gap-3">
            <div className="nexus-metric-card rounded-3xl p-4">
          ...
          <div className="mt-6 rounded-[24px] border border-amber-500/20 bg-slate-900/60 p-4 text-sm text-slate-300">
