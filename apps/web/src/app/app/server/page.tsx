    ...
    <div className="flex flex-col gap-3 md:gap-4">
      ...
      <div className="p-5 md:p-8 border border-white/10 bg-black/40 flex flex-col lg:flex-row lg:items-center justify-between gap-4 md:gap-6">
         <div className="space-y-2">
            ...
            <h1 className="text-2xl md:text-4xl font-black uppercase text-white italic tracking-tight md:tracking-tighter">
         ...
         <div className="flex flex-wrap lg:flex-nowrap items-center gap-2 md:gap-3 w-full lg:w-auto">
            <button 
               ...
               className="px-4 md:px-6 py-3 border border-amber-500/20 bg-amber-500/10 text-[10px] font-black text-amber-500 uppercase tracking-widest hover:bg-amber-500/20 transition-all duration-300 flex items-center gap-2"
            >
               <Plus className="w-3 h-3 text-amber-500" /> Initialize_New_Forge
            </button>
            <Link href="/app/join" className="px-4 md:px-6 py-3 border border-white/10 bg-white/5 text-[10px] font-black uppercase tracking-widest hover:border-amber-500/50 hover:bg-amber-500/10 transition-all duration-300 flex items-center gap-2">
            ...
            <div className="px-3 md:px-4 py-2 border border-white/5 bg-white/5 flex flex-col items-end min-w-[160px] lg:ml-auto">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-3 md:gap-4">
         ...
         <div className="xl:col-span-9 space-y-3">
            {forgesQuery.isLoading ? (
               <div className="p-10 md:p-20 border border-white/10 bg-black/40 flex flex-col items-center justify-center gap-4">
                  <Loader2 className="w-8 h-8 text-amber-500 animate-spin" />
                  <p className="text-[10px] text-slate-500 font-black uppercase tracking-[0.2em]">Retrieving_Cluster_Manifest...</p>
               </div>
            ) : forgeList.length === 0 ? (
               <div className="p-10 md:p-20 border border-white/10 bg-black/40 flex flex-col items-center justify-center gap-6">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                  {forgeList.map((forge: any, idx: number) => (
                     <div
                        key={forge.id}
                        className="p-5 md:p-7 border border-white/10 bg-black/40 space-y-6 md:space-y-7 group hover:bg-white/5 transition-all duration-300 hover:border-amber-500/20 hover:-translate-y-[2px] relative overflow-hidden nf-stagger-item"
                     >
                        ...
                        <div className="flex justify-between items-start relative z-10">
                           <div className="space-y-1">
                              ...
                              <h3 className="text-xl md:text-2xl xl:text-3xl font-black text-white uppercase italic tracking-tight">{forge.name}</h3>
                           </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 relative z-10">
                           <div className="p-3 md:p-4 border border-white/5 bg-slate-950">
                        ...
                        <div className="flex gap-2 relative z-10">
                             ...
                             href={`/forge/${forge.inviteCode}`}
                                           className="flex-1 py-3 md:py-4 bg-amber-500 text-black font-black uppercase tracking-[0.2em] text-[11px] hover:bg-amber-400 transition-all duration-300 flex items-center justify-center gap-2"
                           >
         ...
         <div className="xl:col-span-3 space-y-3">
            <div className="p-5 md:p-8 border border-white/10 bg-black/40 space-y-8">
            ...
            <div className="p-5 md:p-8 border border-white/10 bg-amber-500/5 text-center space-y-4">
