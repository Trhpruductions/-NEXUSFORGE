      ...
      {!isSignedIn ? (
        ...
        <div className="grid gap-6 lg:grid-cols-[1.25fr_0.9fr]">
          <section className="rounded-[28px] border border-white/10 bg-[#11151e] p-6 shadow-[0_24px_60px_rgba(15,23,42,0.08)] backdrop-blur-xl">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              {[
                ...
                <Link
                  key={item.label}
                  href={item.href}
                  className="rounded-[24px] border border-white/10 bg-[#0d1119] p-5 shadow-[0_12px_30px_rgba(15,23,42,0.06)] transition hover:border-amber-300 hover:bg-amber-400"
                >
              ...
              <div className="mt-10 rounded-[28px] border border-white/10 bg-[#11151e] p-5 shadow-[0_18px_45px_rgba(15,23,42,0.07)]">
                ...
                <div className="grid gap-4">
                    ...
                    <input
                      ...
                      placeholder="e.g. Vexora Gaming Helper"
                        className="w-full rounded-[20px] border border-white/10 bg-[#0d1119] px-4 py-3 text-sm text-white outline-none transition focus:border-amber-300"
                    />
                  </label>
            ...
            <div className="mt-10 rounded-[28px] border border-white/10 bg-[#11151e] p-6 shadow-[0_18px_45px_rgba(15,23,42,0.07)]">
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="inline-flex h-9 items-center justify-center rounded-full border border-white/10 bg-amber-400 px-3 text-xs font-semibold text-slate-950 transition hover:bg-[#0d1119]"
                          >
                          ...
                          <span className="rounded-full border border-amber-400/40 bg-amber-500/10 px-3 py-1 text-[11px] uppercase tracking-[0.24em] text-amber-200">
          ...
          <section className="rounded-[28px] border border-white/10 bg-[#11151e] p-6 shadow-[0_24px_60px_rgba(15,23,42,0.08)] backdrop-blur-xl">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-400">Browse public bot apps and discover how other developers publish their work.</p>
            ...
            <div className="mt-6 space-y-3">
              {loading ? (
                ...
                catalogQuery.data.bots.slice(0, 5).map((bot) => (
                  <div key={bot.id} className="rounded-[24px] border border-white/10 bg-[#0d1119] p-4 shadow-[0_12px_30px_rgba(15,23,42,0.06)]">
            ...
            <div className="mt-8 rounded-[24px] border border-white/10 bg-[#0d1119] p-5">
              <p className="text-sm text-white">Developer resources</p>
