...
export default function DeveloperOAuthPage() {
  ...
  return (
    ...
    >
      {!isSignedIn ? (
        <div className="rounded-[28px] border border-white/10 bg-[#11151e] p-8 text-slate-400 shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
          <p>Please sign in to manage OAuth clients and request tokens.</p>
          <a
            href="/login?redirect=/developer/oauth"
            className="mt-4 inline-flex rounded-full bg-sky-500 px-5 py-3 text-sm font-semibold text-white transition hover:bg-sky-400"
          >
            Sign in
          </a>
        </div>
            ...
            <div className="mt-6 grid gap-4">
              <label className="grid gap-2 text-sm text-slate-400">
                ...
                <select
                  ...
                  className="w-full rounded-[20px] border border-white/10 bg-[#0d1119] px-4 py-3 text-sm text-white outline-none focus:border-sky-300"
                >
              ...
              <button
                ...
                className="inline-flex h-12 items-center justify-center rounded-full bg-sky-500 px-5 text-sm font-semibold text-white transition hover:bg-sky-400 disabled:cursor-not-allowed disabled:opacity-60"
              >
                ...
                <div className="rounded-[24px] border border-emerald-400/40 bg-emerald-500/10 p-4 text-sm text-emerald-800">
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-2 break-all text-white">{tokenPayload.access_token}</p>
              ...
              <div className="rounded-[24px] border border-white/10 bg-[#0d1119] p-4 text-sm text-slate-400">
                    ...
                    <div className="rounded-[24px] border border-emerald-400/40 bg-emerald-500/10 p-4 text-sm text-emerald-800">
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        <div>
                          ...
                          <p className="mt-2 break-all text-white">{codeTokenPayload.access_token}</p>
              ...
              <div className="rounded-[24px] border border-white/10 bg-[#11151e] p-4 text-sm text-slate-400">
  ...
  -d "grant_type=client_credentials&client_id=${selectedClientId || "YOUR_CLIENT_ID"}&client_secret=YOUR_CLIENT_SECRET"`}
              ...
              <div className="rounded-[24px] border border-white/10 bg-[#11151e] p-4 text-sm text-slate-400">
                ...
                <div className="mt-4 grid gap-4">
                  ...
                  <div className="rounded-[24px] border border-white/10 bg-[#0d1119] p-3 text-xs text-slate-400">
                    <p className="text-slate-500">Sample authorization URL</p>
                    <div className="mt-2 flex flex-col gap-3">
                      <pre className="max-h-40 w-full overflow-x-auto whitespace-pre-wrap break-all text-[11px] leading-5 text-slate-300">{authorizationUrl || "Select a client and redirect URI to generate a URL."}</pre>
                      {authorizationUrl ? (
