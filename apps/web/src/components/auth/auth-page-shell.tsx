...
export function AuthPageShell({ hero, children }: AuthPageShellProps) {
  return (
    <div className="relative flex min-h-[100dvh] w-full items-center justify-center overflow-hidden bg-[#05030f] px-4 py-8 text-slate-100 sm:px-6">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_15%_15%,rgba(230,179,37,0.16),transparent_34%),radial-gradient(circle_at_85%_20%,rgba(212,160,23,0.14),transparent_32%),radial-gradient(circle_at_50%_100%,rgba(138,101,12,0.14),transparent_40%)]" />
      ...
      <div className="relative z-10 mx-auto my-auto grid w-full max-w-7xl gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <section className="hidden space-y-10 lg:block">
          <Link href="/" className="inline-flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-amber-400/30 bg-slate-950/80 shadow-[0_0_24px_rgba(230,179,37,0.35)]">
              <Image src="/brand/vexora-mark-gold-256.png" alt="Vexora Gaming" width={36} height={36} className="h-9 w-9 rounded-lg object-cover" />
            </div>
            <div>
