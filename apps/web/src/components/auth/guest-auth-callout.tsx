...
export function GuestAuthCallout({
  ...
  return (
    <div className="nexus-panel-glass rounded-none border border-slate-700/70 p-6 text-slate-100 shadow-[0_30px_90px_rgba(0,0,0,0.32)]">
      ...
      <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <Link
          href={registerHref}
          className="nexus-button-secondary inline-flex h-14 items-center justify-center rounded-none px-6 text-sm font-semibold"
        >
          {registerLabel}
        </Link>
      </div>
