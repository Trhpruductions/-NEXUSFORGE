...
export function ProfileSettingsForm() {
  ...
  return (
    <>
      ...
      />
      {intent === "create-forge" ? (
        <div className="mb-4 rounded-none border border-amber-500/35 bg-amber-950/20 p-4 text-sm text-amber-100">
          <p className="text-[10px] uppercase tracking-[0.2em] text-amber-300">Quick Start Intent</p>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <Link href="/app" className="inline-flex h-10 items-center rounded-none border border-amber-500/45 bg-amber-950/35 px-4 text-xs font-semibold text-amber-100 hover:border-amber-300">
              Open Command Center
            </Link>
            <Link href="/search?q=community" className="inline-flex h-10 items-center rounded-none border border-slate-600/80 bg-slate-900/70 px-4 text-xs font-semibold text-slate-100 hover:border-amber-500/45">
              Explore Existing Communities
            </Link>
          </div>
        </div>
      ) : null}
      <div className="nexus-display-panel relative grid gap-4 rounded-none p-5 sm:p-6">
        ...
        <div className="relative flex flex-wrap items-center gap-2 rounded-none border border-amber-500/30 bg-amber-950/15 px-3 py-2 text-xs">
          ...
          <span className="rounded-none border border-amber-500/35 bg-amber-950/25 px-2 py-0.5 text-amber-100">
        ...
        <div className="relative grid gap-3 rounded-none border border-amber-500/20 bg-amber-950/10 p-4 md:grid-cols-[1.2fr_auto] md:items-center">
          <div className="space-y-1 text-sm text-slate-200">
            <p className="text-xs uppercase tracking-[0.2em] text-amber-300">Billing Control</p>
            <p>
        ...
        <div className="relative grid gap-4 xl:grid-cols-[1.25fr_0.75fr]">
          <div className="nexus-panel rounded-none p-4 sm:p-5">
            <div className="mb-4 flex items-center justify-between gap-3">
              <div>
                <p className="text-[10px] uppercase tracking-[0.2em] text-amber-300">Identity Matrix</p>
                <p className="mt-1 text-sm text-slate-400">Refine your public identity, presence layer, and current activity feed.</p>
              </div>
              <div className="rounded-none border border-slate-700/80 bg-slate-950/65 px-3 py-1 text-[10px] uppercase tracking-[0.18em] text-slate-400">
                Live draft
              </div>
            </div>
            ...
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <label className="grid gap-2 text-sm text-slate-300 md:col-span-2">
                ...
                <textarea
                  ...
                  className="min-h-28 rounded-none border border-slate-700 bg-slate-900/70 px-3 py-2 text-slate-100 outline-none transition focus:border-amber-400 focus:ring-2 focus:ring-amber-500/20"
              ...
              <label className="grid gap-2 text-sm text-slate-300 md:col-span-2">
                ...
                <select
                  ...
                  className="h-11 rounded-none border border-slate-700 bg-slate-900/70 px-3 text-slate-100 outline-none transition focus:border-amber-400 focus:ring-2 focus:ring-amber-500/20"
                >
          ...
          <div className="grid gap-3">
            <div className="nexus-signal-rail rounded-none px-4 py-4">
            ...
            <div className="nexus-metric-card rounded-none p-4">
              <p className="text-[10px] uppercase tracking-[0.18em] text-amber-300">Quick Summary</p>
              <div className="mt-3 grid gap-2 text-sm text-slate-300">
                <div className="flex items-center justify-between rounded-none border border-slate-800 bg-slate-950/55 px-3 py-2">
                  <span>Presence</span>
                  <span className="text-amber-200">{form.status}</span>
                </div>
                <div className="flex items-center justify-between rounded-none border border-slate-800 bg-slate-950/55 px-3 py-2">
                  <span>Branding Kit</span>
                  <span className={hasBrandingKit || isBetaCosmeticsBypass ? "text-amber-200" : "text-amber-200"}>
        ...
        {cosmeticUpsellVisible ? (
          <div className="rounded-none border border-amber-500/30 bg-amber-950/15 p-4 text-sm text-amber-100">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <Link href="/pricing" className="inline-flex h-10 items-center rounded-none border border-amber-400/45 bg-amber-400 px-4 text-sm font-semibold text-slate-950 hover:bg-amber-300">
                Unlock Team Branding Kit
              </Link>
              <Link href="/core-plus" className="inline-flex h-10 items-center rounded-none border border-amber-500/35 bg-amber-950/25 px-4 text-sm font-semibold text-amber-100 hover:border-amber-300">
                Review Billing
              </Link>
            </div>
          </div>
        ...
        {pushState ? <p className="text-xs text-amber-300">{pushState}</p> : null}
