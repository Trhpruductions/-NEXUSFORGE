  ...
  return (
    <section className="grid gap-4 lg:grid-cols-[1.2fr_1fr]">
      ...
      >
        ...
        <p className="relative z-10 text-[11px] uppercase tracking-[0.26em] text-amber-300">Vexora Gaming Identity</p>
        <h2 className="relative z-10 mt-2 font-[family-name:var(--font-orbitron)] text-2xl text-white sm:text-4xl">
        ...
        <div className="relative z-10 mt-4 grid gap-2 text-xs text-slate-400 sm:grid-cols-3">
          <div className="glass-cut rounded-full border border-white/10 bg-[#11151e] px-3 py-2">Reactive gradients</div>
          <div className="glass-cut rounded-full border border-white/10 bg-[#11151e] px-3 py-2">Animated premium framing</div>
          <div className="glass-cut rounded-full border border-white/10 bg-[#11151e] px-3 py-2">Live app identity surfaces</div>
        </div>
      ...
      <div className="grid gap-4">
        <motion.article
          ...
          className="nexus-panel relative overflow-hidden rounded-[28px] border border-white/10 bg-[#11151e] p-5 shadow-[0_18px_45px_rgba(15,23,42,0.07)]"
        >
          <p className="text-[11px] uppercase tracking-[0.2em] text-amber-300">Boost Tier Badges</p>
          ...
          <p className="mt-3 text-xs text-amber-200">Used as the canonical tier art across pricing and Core+ surfaces.</p>
        </motion.article>
        ...
        <motion.article
          ...
          className="nexus-panel relative overflow-hidden rounded-[28px] border border-white/10 bg-[#11151e] p-5 shadow-[0_18px_45px_rgba(15,23,42,0.07)]"
        >
          <p className="text-[11px] uppercase tracking-[0.2em] text-amber-300">Boost Pack Emblem</p>
          ...
          <p className="mt-3 text-xs text-amber-200">Designed for visible progression and high-retention engagement loops.</p>
        </motion.article>
      </div>
    </section>
  );
