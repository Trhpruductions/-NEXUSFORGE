...
| --- | --- | --- | --- | --- | --- | --- | --- |
| CG-PROD-01 | Dashboard and Core Product Workflows | Local smoke + feature flows pass without regressions | `npm run smoke:local` | Product Lead | 2026-07-04 | `var/release-evidence/2026-07/product-e2e-01.txt` | Complete (2026-07-02; 31/31 tests PASS) |
| CG-PERF-01 | Performance and Reliability | Cold-start p95 and crash-free rate validated | `npm run smoke:local` (benchmarks); watchdog soak analysis | Platform Lead | 2026-07-04 | `var/release-evidence/2026-07/performance/pd-perf-01.txt` | Complete (2026-07-02; p95 ~21s, 100% crash-free) |
